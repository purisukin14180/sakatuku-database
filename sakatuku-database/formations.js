...
const FORMATIONS_DATA = [
    ...
    // Lv.10解放
    { name: "太極戦士'02", policy: "ポゼッション", formation: "3-4-3 B", level: "10", coin: 5, keys: "CB(ストッパーⅡ以上)、LM(ドリブラーⅡ以上)", effect: "キ精度・キープ力・ジャンプ 60%UP" },
    ...
    { name: "ラ・ロハ'24", policy: "ポゼッション", formation: "4-3-3 B", level: "20", coin: 20, keys: "RB(攻撃的FBⅡ以上)、RDM(パサーⅡ以上)、RW(ドリブラーⅢ以上)", effect: "冷静さ・キ精度・パスカット・コンタクト 80%UP" },
    { name: "レ・ブルー'98", policy: "カウンター", formation: "4-4-2 D", level: "20", coin: 20, keys: "LSB(守備的FBⅡ以上)、AM(セントラルMFⅡ以上)、RCF(ストライカーⅢ以上)", effect: "キ力・ジャンプ・コンタクト・敏捷性 80%UP" },
    { name: "ディアボロ・ディ・ミラノ'99", policy: "カウンター", formation: "3-4-3 B", level: "20", coin: 20, keys: "RCB(組立CBⅡ以上)、RDM(セントラルMFⅢ以上)、LW(ドリブラーⅡ以上)", effect: "キ力・突破力・ジャンプ・コンタクト 80%UP" },
    { name: "ゴーデンゾーネン'94", policy: "リアクション", formation: "3-4-3 C", level: "20", coin: 20, keys: "CB(ストッパーⅡ以上)、LDM(ハードマーカーⅡ以上)、RDM(セントラルMFⅢ以上)", effect: "キ精度・突破力・コンタクト・スタミナ 80%UP" },
    ...
    { name: "ソベラーノ'94", policy: "ムービング", formation: "4-4-2 E", level: "20", coin: 20, keys: "LAM(パサーⅡ以上)、RAM(アタッカーⅡ以上)、LCF(ストライカーⅢ以上)", effect: "キ力・突破力・コンタクト・スタミナ 80%UP" },
